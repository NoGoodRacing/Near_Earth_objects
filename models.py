...
class NearEarthObject:
    ...
    def __init__(self, **info):
        ...
        self.name = self.set_name(info.get('name'))
        try:
            self.diameter = self.set_diameter(info.get('diameter'))
        except ValueError as err:
            print(err)
        self.hazardous = self.set_is_hazardous(info.get("pha"))
        self.approaches = []
    ...
    @staticmethod
    def set_diameter(param):
        """Return a diameter attribute converted in float type."""
        if param:
            return float(param)
        else:
            return float('nan')
    ...
    @staticmethod
    def set_is_hazardous(param):
        """Return a representation of hazardous attribute in boolean type."""
        return param == "Y"
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject {self.fullname} has a diameter of {self.diameter:.3f} km and " \
               f"{['is not', 'is'][self.hazardous]} potentially hazardous"
...
class CloseApproach:
    ...
    def designation(self):
        """Return self._designation attribute of approach object."""
